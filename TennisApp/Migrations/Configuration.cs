        ...
        protected override void Seed(TennisApp.Models.ApplicationDbContext context)
        {
            ...
            var noticias = new List<Noticia> {
                new Noticia  {IdNoticia= 1, Titulo = "Treinos 2017/2018",
                                ...
                                Foto = "a", TipoImagem = "a", Relevancia = 1, DataPublicacao = new DateTime(2017,9,9,20,00,00),
                ...
                new Noticia  {IdNoticia= 2, Titulo = "VI Torneio Tomar Jovem - Regulamento",
                                ...
                                Foto = "b", TipoImagem = "b", Relevancia = 1, DataPublicacao = new DateTime(2017,9,10,20,00,00),
                ...
                new Noticia  {IdNoticia= 3, Titulo = "IV Torneio Cidade Tomar - Adiamento",
                                ...
                                Foto = "c", TipoImagem = "c", Relevancia = 1, DataPublicacao = new DateTime(2017,9,11,20,00,00),
                ...
                new Noticia  {IdNoticia= 4, Titulo = "VI Torneio Cidade Tomar - Regulamento",
                                ...
                                Foto = "d", TipoImagem = "d", Relevancia = 1, DataPublicacao = new DateTime(2017,9,12,20,00,00),
                ...
                new Noticia  {IdNoticia= 5, Titulo = "5 Jovens Tenistas do TCT no SmashTour_CTSantarém",
                                ...
                                Foto = "e", TipoImagem = "e", Relevancia = 1, DataPublicacao = new DateTime(2017,9,12,21,00,00),
                ...
                new Noticia  {IdNoticia= 6, Titulo = "A Torre de tandil... está de volta!",
                                ...
                                Foto = "f", TipoImagem = "f", Relevancia = 1, DataPublicacao = new DateTime(2017,9,13,22,30,00),
